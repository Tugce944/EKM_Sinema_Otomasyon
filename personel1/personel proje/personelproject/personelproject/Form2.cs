    ...
    public partial class Form2 : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            if (kayıtkontrol == false)
            {
                ...
                if (pictureBox2.Image != null && textBox7.Text != "" && textBox8.Text != "" && textBox9.Text != "" && comboBox1.Text != "" && comboBox3.Text != ""
                    && comboBox4.Text != "" && textBox10.Text != "false") ;
                ...
                try
                {
                    string sorgu = "INSERT INTO personeller(tcno,ad,soyad,cinsiyet,mezuniyet,dogum.tarihi,gorevi,gorev.yeri,maasi)" +
                         "values(66666666666,'Seray','Yıldız','Kadın','Lise',12.10.1990,'Muhasebe','Bilgi.işlem',4000) ";
                    ...
                    pictureBox2.Image.Save(Application.StartupPath + "\\personelresimler\\" +textBox7.Text+".jpg");
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (textBox7.Text.Length == 11) ;
            {
                ...
                while (kayitokuma.Read())
                {
                    ...
                    textBox8.Text = kayitokuma.GetValue(8).ToString();
                    break;
                }
                if (kayit_arama_durumu == false)
